...
public class JsonUtils {
    ...
    public static Sandwich parseSandwichJson(String json) {
        ...
        if (jsonObject != null) {
            ...
            if (name != null) {
                mainName = getJsonString(name, MAIN_NAME_KEY, true);
            ...
            placeOfOrigin = getJsonString(jsonObject, PLACE_OF_ORIGIN_KEY, false);
            description = getJsonString(jsonObject, DESCRIPTION_KEY, false);
            imageUrl = getJsonString(jsonObject, IMAGE_URL_KEY, true);
     ...
     * @return
     */
    private static String getJsonString(JSONObject json, String key, boolean isImage) {
        try {
